...
export default function HeroSection({
  ...
  return (
    <section className="relative flex min-h-[100dvh] overflow-hidden bg-[#E9E9E7] px-5 pt-[clamp(1rem,3dvh,2rem)] pb-[clamp(4rem,8dvh,6rem)] sm:px-10 md:px-16 lg:px-24">
