                ...
                <motion.div key={i} variants={itemVariants}>
                  <div className="flex items-center justify-between py-4 sm:py-6 border-t border-[#1F2A1F]/10 cursor-pointer group transition-all">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-lg sm:text-xl font-bold uppercase tracking-widest group-hover:text-[#004643] transition-colors">{collection.title}</span>
                    </div>
                  </div>
                  {collection.description && (
                    <p className="text-xs sm:text-sm text-stone-600 ml-9 -mt-2">{collection.description}</p>
                  )}
                </motion.div>
              )) : (
                <>
