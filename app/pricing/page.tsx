      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        ...
        <div className="flex flex-col gap-4 sm:gap-6">
          {displayPlans.map((pkg, index) => (
            ...
            >
              <div className={`absolute left-0 top-4 sm:top-1/2 sm:-translate-y-1/2 w-2.5 sm:w-3 h-16 sm:h-20 md:h-24 rounded-r-full ${pkg.color || 'bg-orange-500'}`} />
              ...
              <div className="w-full md:w-1/3 mb-4 sm:mb-6 md:mb-0 pl-2">
                ...
                <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">{pkg.description}</p>
              </div>

              <div className="w-full md:w-1/4 mb-4 sm:mb-6 md:mb-0 text-left md:text-center">
                <span className="text-xl sm:text-2xl md:text-3xl font-black tracking-tighter">{pkg.price}</span>
              </div>
